...
public class MainActivity extends AppCompatActivity {
    ...
    //mqtt://mqttrepo:OJedDCKQohtGQ6FR@mqttrepo.cloud.shiftr.io
    String clienteID = "";
    static String MQTTHOST = "tcp://mqttrepo.cloud.shiftr.io:1883";
    static String MQTTUSER = "mqttrepo";
    static String MQTTPASS = "OJedDCKQohtGQ6FR";
